...
คือบอกว่า printf รับค่าตัวแรกเป็น `const char*` และตัสถัดมาเป็น `__gnuc_va_list` แล้ว return ค่ากลับไปเป็น `int` แต่ไม่ได้มีการ implement จริงๆอยู่ตรงนั้น
...
ซึ่งเราก็ส่งค่า `int` กลับไปจริงๆใรบรรทัดที่ `return 0;` เพราะ 0 เป็นจำนวนเต็ม

เลข 0 นี้หมายถึงสถานะสุดท้ายของโปรแกรม
...
`printf` เป็น functionที่ใช้แสดงค่า CharSequence ออกมาทางหน้าจอ (standard output)
...
| %f            | แสดงผลในรูปแบบของ Float (ทศนิยม)                                         | 3.141    |
...
```text
0 % 3 == 0  เพราะว่า 0 เขียนในรูป 3x + ได้
1 % 3 == 1  เพราะว่า 1 เขียนในรูป 3x + ได้
2 % 3 == 2  เพราะว่า 2 เขียนในรูป 3x + ได้
3 % 3 == 0  เพราะว่า 3 เขียนในรูป 3x + ได้
4 % 3 == 1  เพราะว่า 4 เขียนในรูป 3x + ได้
5 % 3 == 2  เพราะว่า 5 เขียนในรูป 3x + ได้
6 % 3 == 0  เพราะว่า 6 เขียนในรูป 3x + ได้
7 % 3 == 1  เพราะว่า 7 เขียนในรูป 3x + ได้
8 % 3 == 2  เพราะว่า 8 เขียนในรูป 3x + ได้
9 % 3 == 2  เพราะว่า 9 เขียนในรูป 3x + ได้
