<script lang="ts">
  ...
  const components = new Map<string, ComponentType>([["Callout", Callout], ["Prism", Prism]]);
  ...
  <div class="bg-orange-600 text-white">
		<div class="prose prose-invert pb-8 pt-6">
			...
			<div class="flex gap-2">
				...
				<Button href="/" class="mb-3 inline-block" icon={ChevronLeft}>
					ย้อนกลับ	
				</Button>
				<Button href="{data.github_link}" class="mb-3 inline-block" icon={Github}>
					แก้ไขหน้านี้
				</Button>
			</div>
